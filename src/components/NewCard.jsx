...
const NewCard = ({ data, onClose, updateCsvData }) => {
    ...
    return (
        <>
            ...
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-14 rounded-lg shadow-md border-2 newData">
                <div>
                    <h5 className="text-2xl font-semibold mb-10">Add Data</h5>

                    {Object.entries(data).map(([key, value]) => (
                        <div key={key} className="mb-4 flex items-between">
                            <div className="w-3/6">
